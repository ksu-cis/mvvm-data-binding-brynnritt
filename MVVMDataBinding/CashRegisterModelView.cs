    ...
    class CashRegisterModelView : INotifyPropertyChanged
    {
        ...
        public int Pennies
        {
            ...
            set
            {
                ...
                //drawer.Pennies is readonly, so add pennies method is required
                var quantity = value - drawer.Pennies; //if pennies are being added or subtracted
        ...
        /// <summary>
        /// Helper methid for triggering PropertyChanged events
        /// </summary>
        /// <param name="denomination">The denomonation property that is changing</param>
